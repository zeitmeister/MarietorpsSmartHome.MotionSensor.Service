...
Set-SCPItem -ComputerName 192.168.0.107 -Credential $cred -Path C:\Users\simon\hobby_projects\MarietorpsSmartHome.MotionSensor.Service\published\ -Destination "/home/pi/MarietorpsSmartHome.MotionSensor/" -Verbose 
